...
export default function setFour() {
	return (
		<div className="page book book-page two-content">
				...
				<div className="content">
					...
					<ul>
						...
						<li className="small-screen">
							Love is my shield to repulse the arrows of hate and the spears of
							anger.
						</li>
						<li className="small-screen">
							And most of all I will love myself. For when I do I will zealously
							inspect all things which enter my body, my mind, my soul, and my
							heart.
						</li>
					</ul>
				</div>
			...
			<div className="page half back three-title">
				<div className="content">
					{/* <h6>Page 8</h6> */}
